                  ...
                  .then(async function (response) {
                    if (response.data == 'NULL') {
                      ...
                      try {
                        ...
                        console.log('providers:'+'Não consegui enviar a mensagem!')
                      }
                    } else {
                      let nome
                      let cpf_cnpj
                      ...
                      try {
                        ...
                        console.log('providers:'+'11 Não consegui enviar a mensagem!')
                      }
                    }
                  })
                  .catch(async function (error) {
                    try {
                      ...
                      console.log('providers:'+'111 Não consegui enviar a mensagem!')
                    }
          ...
          if (isCPFCNPJ) {
            ...
            axios.request(options as any).then(async function (response) {
              if (response.data.type === 'error') {
                console.log("providers:","Error response", response.data.message);
                const body = {
                  text: formatBody(`*Opss!!!!*\nOcorreu um erro! Digite *#* e fale com um *Atendente*!`, contact),
                };
                await sleep(2000)
