...
const NewTicketModal = ({ modalOpen, onClose, initialContact }) => {
  ...
  const handleSaveTicket = async contactId => {
    ...
    if (selectedQueue === "" && user.profile !== 'admin') {
      toast.error(`${i18n.t("newTicketModal.select.queue")}`);
      return;
    }
          ...
          <Grid style={{ width: 300 }} container spacing={2}>
            ...
            <Grid xs={12} item>
              <Select
                ...
                renderValue={() => {
                  if (selectedQueue === "") {
                    return `${i18n.t("newTicketModal.select.queue")}`
                  }
            ...
            <Grid xs={12} item>
              <Select
                ...
                renderValue={() => {
                  if (selectedWhatsapp === "") {
                    return `${i18n.t("newTicketModal.select.connection")}`
                  }
